...
const nsPluginWithHooksAfterPrepareFilePath = path.join(afterPrepareHooksDir, "ns-plugin-with-hooks.js");
if (!fs.existsSync(nsPluginWithHooksAfterPrepareFilePath)) {
	fs.writeFileSync(nsPluginWithHooksAfterPrepareFilePath, 'module.exports = require("ns-plugin-with-hooks")');
}
